  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      ...
      <p className="mt-4 text-sm text-muted-foreground">
        © 2026 ESG Smart Performance. All components of this web application—including proprietary software, design
        frameworks, UI assets, and data visualization modules—were developed by Arnon Arpaket and are licensed
        exclusively for this platform. No part of the program or its content may be copied, reproduced, modified, or
        distributed without prior written consent from the creator.
      </p>
    </div>
  );
}
